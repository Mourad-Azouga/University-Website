          ...
          <div class="navbar">
            ...
            <ul>
              <li><a href="{{ url('/dashboard') }}" onclick="untoggleall()">
                ...
                <span class="nav-item" onclick="{{ url('/dashboard') }}">Dashboard</span>
              </a>
              </li>
              <li><a href="#">
                <i class="fa fa-calendar"></i>
                <span class="nav-item" href="toggleDiv('emploi')">Emploi Du Temps</span>
              </a>
              </li>
              <li><a href="#">
          ...
          <!-- --------------------------formulaire--------------------------- --> 
            ...
            <div class="main-body">
              <div id="annonces" class="annonces">
                  ...
                  <form action="{{ route('modifier_salle') }}" method="POST">
                      @csrf
                      
                      <label for="salle-id">Votre salle :</label>
                      <select name="salle-id" id="salle-id">
                          @foreach($salles as $salle)
                              <option value="{{ $salle->ID_salle }}">{{ $salle->Nom_salle }}</option>
                          @endforeach
                      </select>
                  
                      <label for="salle-type">Type de salle :</label>
                      <input id="salle-type" name="salle-type" type="text">
