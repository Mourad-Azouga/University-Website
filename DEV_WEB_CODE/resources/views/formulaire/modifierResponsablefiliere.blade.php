...
<head>
    ...
    <title>Modifier Responsable de filiere</title>
    <script>
          ...
          <!-- --------------------------formulaire--------------------------- --> 
            ...
            <div class="main-body">
                <div id="annonces" class="annonces">
                    <h1>Modifier Responsable de filiere</h1>

                    <form action="{{ route('modifier_responsable_filiere') }}" method="post">
                        @csrf
                        <!-- Utilisez le nom correct pour le champ du département -->
                        <label for="filiere_id">Choisir le filiere :</label>
