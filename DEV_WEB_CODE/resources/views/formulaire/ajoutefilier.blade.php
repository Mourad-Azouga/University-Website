          ...
          <!-- --------------------------formulaire--------------------------- --> 
            ...
            <div class="main-body">
                <div id="annonces" class="annonces">
                    ...
                    <form action="{{ route('ajoute_filiere') }}" method="post">
                        @csrf
                        ...
                        <input type="text" name="nouveau_nom1" id="nouveau_nom1" required>

                        <label for="description_module1">Description module :</label>
                        <textarea name="nouvelle_description1" id="nouvelle_description1" rows="4" required></textarea>

                        <label for="nom_module2"> Nom module2 :</label>
                        <input type="text" name="nouveau_nom2" id="nouveau_nom2" required>
